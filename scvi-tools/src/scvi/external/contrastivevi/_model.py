...
class ContrastiveVI(BaseModelClass):
    ...
    def __init__(
        ...
        self.n_input = self.summary_stats.n_vars - n_me
        
        #print(self.n_input)

        self.module = self._module_cls(
            n_input=self.summary_stats.n_vars - n_me,
            n_input_full=self.summary_stats.n_vars,
            n_batch=n_batch,
            n_hidden=n_hidden,
    ...
    def get_latent_representation(
        ...
        for tensors in data_loader:
            ...
            outputs = self.module._generic_inference(x=x, index=self.n_input, batch_index=batch_index, n_samples=1)
